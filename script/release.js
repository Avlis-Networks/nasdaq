...
const token = process.env.AVLIS_GITHUB_TOKEN;
  ...
  const zipAssets = [
    {
      ...
      path: path.join(outPath, 'AVLIS-darwin-x64', 'AVLIS.app'),
    },
    {
      name: 'electron-api-demos-windows.zip',
      path: path.join(outPath, 'AVLIS-win32-ia32'),
    },
    {
      name: 'electron-api-demos-linux.zip',
      path: path.join(outPath, 'AVLIS-linux-x64'),
    },
  ];
